...
//  RevCity
//
//  Created by Brian Rollison on 3/4/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    /** Overall preparation after launch occurs **/
    ...
    /** Called once the user has logged in in some way or another **/
